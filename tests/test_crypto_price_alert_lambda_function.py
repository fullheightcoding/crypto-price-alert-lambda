...
import crypto_price_alert_lambda

class TestCryptoPriceAlert(unittest.TestCase):
    # Rest of the test code...
    def test_main(self):
        loop = asyncio.get_event_loop()
        result = loop.run_until_complete(crypto_price_alert_lambda.main("bitcoin", 10000, "less_than"))
    ...
    def test_lambda_handler(self):
        ...
        with patch('crypto_price_alert_lambda.boto3.client') as boto3_client_mock:
            ...
            response = crypto_price_alert_lambda.lambda_handler(event, context)
